 ...
 */
public class YomlBasicTests {

    private static final Logger log = LoggerFactory.getLogger(YomlBasicTests.class);
    ...
    public void testFieldInFieldsUsingTestFixture() {
        YomlTestFixture.newInstance().writing( new Shape().color("red") ).
        reading(
    ...
    public void testFieldInExtendedClassInFields() {
        YomlTestFixture.newInstance().writing( new ShapeWithSize().size(4).color("red") ).
        reading(
    ...
    public void testFieldInExtendedClassInFieldsDefault() {
        ...
        YomlTestFixture.newInstance().writing( new ShapeWithSize().color("red") ).
        reading(
            Jsonya.newInstance().add("type", "java"+":"+ShapeWithSize.class.getName())
            .at("fields").add("color", "red", "size", 0).root().toString() ).
        doReadWriteAssertingJsonMatch();
    ...
    public void testFailOnUnknownType() {
        try {
            YomlTestFixture ytc = YomlTestFixture.newInstance().read("{ type: shape }", null);

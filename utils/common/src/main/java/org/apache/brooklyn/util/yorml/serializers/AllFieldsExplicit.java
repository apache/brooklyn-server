...
public class AllFieldsExplicit extends YormlSerializerComposition {
    ...
    public class Worker extends YormlSerializerWorker {
        ...
        protected void run() {
            ...
            List<String> fields = YormlUtils.getAllNonTransientNonStaticFieldNames(getJavaObject().getClass(), null);
            for (String f: fields) {

...
/**
 * This is an exact copy of the corresponding class patching jclouds 1.9.2 contained in:
 * https://github.com/jclouds/jclouds/pull/931
 * (with the addition of this comment).
 * 
 * This file should be removed when Brooklyn is using jclouds with that patch, likely 1.9.3 or 2.0.0.
 * Until then it is likely -- but not guaranteed! -- that java will pick up this class in preference
 * to the one in jclouds-softlayer which it is masking. 
 */
@Singleton
